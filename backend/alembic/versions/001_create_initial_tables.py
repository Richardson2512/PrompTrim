...
def upgrade() -> None:
    ...
    op.create_table('prompt_optimizations',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_prompt_optimizations_id'), 'prompt_optimizations', ['id'], unique=False)


def downgrade() -> None:
    op.drop_index(op.f('ix_prompt_optimizations_id'), table_name='prompt_optimizations')
